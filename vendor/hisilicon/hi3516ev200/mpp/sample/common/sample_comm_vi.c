...
static int CIJ_SENSOR_TYPE = SENSOR0_TYPE;
...
{
#define SENSOR_IMX307   0
#define SENSOR_GC2053   1
    switch(type){
    case SENSOR_IMX307:
        CIJ_SENSOR_TYPE= SONY_IMX307_2L_MIPI_2M_30FPS_12BIT;
        break;
    case SENSOR_GC2053:
        CIJ_SENSOR_TYPE= GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT;
        break;
    default:
        break;
    }
...
HI_VOID SAMPLE_COMM_VI_GetSensorInfo(SAMPLE_VI_CONFIG_S *pstViConfig)
{
    ...
    pstViConfig->astViInfo[0].stSnsInfo.enSnsType = CIJ_SENSOR_TYPE;
}
